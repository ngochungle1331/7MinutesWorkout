...
import com.example.a7minutesworkout.databinding.DialogCustomBackAnimationBinding
import java.util.*
...
class ExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private fun customDialogForBackButton() {
        ...
        val dialogBinding = DialogCustomBackAnimationBinding.inflate(layoutInflater)
